...
updateTrainerForm.addEventListener("submit", function (e) {
    ...
    let matchIDValue = document.getElementById("mySelect").value;
    let trainerPhoneValue = document.getElementById("input-edit-contestant-1").value;
    let trainerEmailValue = document.getElementById("input-edit-contestant-2").value;
